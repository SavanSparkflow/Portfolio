  ...
  return (
    <section id="about" className="relative min-h-screen flex flex-col justify-center items-center px-5 sm:px-8 md:px-10 py-20 bg-[#0C0C0C] overflow-hidden">
      ...
      <div className="relative z-10 flex flex-col items-center max-w-4xl w-full">
        ...
        <div className="text-[#D7E2EA] font-medium text-center leading-relaxed max-w-[560px] text-[clamp(1rem,2vw,1.35rem)] mb-16 sm:mb-20 md:mb-24">
          <AnimatedText 
            text="With 3 years of experience as a Frontend Developer, i specialize in React and modern web technologies. i truly enjoy building scalable, fast web applications and translating complex ideas into interactive, seamless user interfaces. Let's build something incredible together!" 
          />
        </div>
